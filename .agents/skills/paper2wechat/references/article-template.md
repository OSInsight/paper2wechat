...
1. [论文/综述 1（尽量含链接；若无法可靠确认可不加）]
2. [论文/综述 2（尽量含链接；若无法可靠确认可不加）]
3. [可选：论文/综述 3（尽量含链接；若无法可靠确认可不加）]

### 技术工具与资源

- [开源项目/代码仓库（尽量含链接；若无法可靠确认可不加）]
- [数据集/评测集（尽量含链接；若无法可靠确认可不加）]
- [可选：文档/教程/项目主页（尽量含链接；若无法可靠确认可不加）]
